...
You only want to read an article *once*.
...
::: {style="position: relative; top: 40%; font-size: xx-large;"}
<h2>Avoid kitchen sink analyses.</h2>
:::
...
## Conclusion example 1 (start) {.smaller}
...
## Conclusion example 2 (start) {.smaller}
...
You will be editing this document daily, your marker won't! Guide them through it.
...
- [ ] USE flow diagrams!
- [ ] When reading old dissertations don't just read them whole - read one introduction and then compare that with another introduction + make notes on them
...
```r 
echo=FALSE, out.width = "400pt", fig.align='center'}
...
.pull-left[
```r 
image_grobs, echo=FALSE, fig.align="default", out.width="100%"}
knitr::include_graphics('img/GanttChart.png') 
```
]
.pull-right[
```r 
image_grobs2, echo=FALSE, fig.align="default", fig.show="hold", out.width="100%"}
knitr::include_graphics('img/trello.png') 
```
]

```r 
image_grobs3, echo=FALSE, fig.align="default", fig.show="hold", out.width="40%"}
...
::: {style="position: relative; top: 40%; font-size: xx-large;"}
<h2>Remember it's <em>your</em> project!</h2>
:::